...
Write-Host " a.  Use Minecraft Forge 1.20.1 v47.3.0"
Write-Host " b.  Remember to allocate 8GB of RAM to the game before starting it!"
Write-Host ""
Write-Host "        _____"
Write-Host "    ,-:' \;',''-,"
Write-Host "  .'-;_,;  ':-;_,'"
...
Write-Host "OR"
Write-Host "Press Enter to clean up and exit the script. (*USE ENTER)"
